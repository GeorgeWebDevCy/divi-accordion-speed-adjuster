 ...
 * 
 * You can add the localized variables in here as followed: gntogglean.plugin_name
 * These variables are defined within the localization function in the following file:
 * core/includes/classes/class-gn-toggle-and-accordion-animation-disabler-run.php
 * 
 * HELPER COMMENT END
 */
