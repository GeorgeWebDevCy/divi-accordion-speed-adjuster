 ...
 * Text Domain:   gn-accordion-speed-adjuster
 ...
 */
require_once DIVIACCORD_PLUGIN_DIR . 'core/class-gn-accordion-speed-adjuster.php';
...
function divi_accordion_admin_notice() {
    ...
    echo sprintf( __( '%s requires Divi or a child theme of Divi to be active. Please activate Divi or a Divi child theme and try again.', 'gn-accordion-speed-adjuster' ), DIVIACCORD_NAME );
    echo '</p></div>';
}
